    ...
    return (
      <div className='container'>
        ...
        <div className='list-group'>
          ...
          <a className='list-group-item' href='#/galaxy/nuget?l=1'>NuGet</a>
          ...
          <a className='list-group-item' href='#/galaxy/arch?cx=870&cy=-3968&cz=-2010&lx=0.7695&ly=-0.3554&lz=0.3109&lw=0.4299&ml=150&s=1.75&l=1&v=no-aur'>Arch Linux</a>
          <a className='list-group-item' href='#/galaxy/arch?cx=2655&cy=859&cz=7898&lx=0.2160&ly=0.0620&lz=0.8560&lw=0.4656&ml=150&s=1.75&l=1&v=including-aur'>Arch Linux (including AUR)</a>
